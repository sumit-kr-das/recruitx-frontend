    ...
    return (
        <div className="shadow rounded-md bg-white border rounded-xl p-5">
            <form onSubmit={submitRating}>
                ...
                <Textarea className="h-40 px-3 text-sm py-1 mt-5 outline-none border-gray-300 w-full resize-none border rounded-lg placeholder:text-sm" placeholder="Add your comments here" value={desc} onChange={(e) => setDesc(e.target.value)}></Textarea>
