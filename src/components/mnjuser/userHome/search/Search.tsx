...
const Search = () => {
  ...
  const search = () => {
    navigate(
      `../../mnjuser/jobs?title=${data.skill}&location=${data.location}`
    );
  };

  return (
    <div className="w-full flex items-center justify-center">
      <div className="bg-white md:w-8/12 flex items-center justify-center gap-4 border-2 rounded-lg shadow px-3 py-2">
